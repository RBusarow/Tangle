...
dependencies {
  ...
  dependencySync("com.google.dagger:hilt-android-compiler:2.40.1")
  dependencySync("com.google.dagger:hilt-android-gradle-plugin:2.40.1")
  dependencySync("com.google.dagger:hilt-android:2.40.1")
