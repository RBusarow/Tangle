...
dependencies {
  ...
  dependencySync("com.google.dagger:hilt-android-gradle-plugin:2.39")
  dependencySync("com.google.dagger:hilt-android:2.39")
  dependencySync("com.google.dagger:hilt-android-testing:2.39")
